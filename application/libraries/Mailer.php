...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'noreply@asiagalaxy.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Info Request Annual Leave'; // Isikan dengan nama pengirim
    protected $password = 'ITgih2022'; // Isikan dengan password email pengirim
    ...
    public function send($data, $mailto='', $ccmail=''){
        ...
        $mail->Host = 'srv163.niagahoster.com';
