<div class="page">
  ...
  <div class="page-header" style="text-align: center; padding: 0px;">
    <h1 class="page-title">Form Update Incoming Ship</h1>
  </div>
              ...
              <div class="col-md-12 col-lg-6">
                <div class="example-wrap">
                  <div class="example">
                    ...
                    <?= form_open(base_url('frontend/incoming_ship/update_incoming_ship'),  'id="login_validation" enctype="multipart/form-data"') ?>
                    <div hidden class="form-group row">
                      <label class="col-md-3 form-control-label"><b>Id Incoming<b style="color: red;">*</b> : </b></label>
                      <div class="col-md-9">
                        <input type="text" required="required" value="<?=$income->id_incoming?>" class="form-control" name="id_incoming" placeholder="Nomor PUK" autocomplete="off" id="id_incoming" />
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-md-3 form-control-label"><b>Nomor PUK<b style="color: red;">*</b> : </b></label>
                      <div class="col-md-9">
                        <input type="text" required="required" value="<?=$income->nomor_puk?>" class="form-control" name="no_puk" placeholder="Nomor PUK" autocomplete="off" id="no_puk" />
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-md-3 form-control-label"><b>Date PUK<b style="color: red;">*</b> : </b></label>
                      <div class="col-md-9">
                         <input type="date" required="required" value="<?=$income->tanggal_puk?>" class="form-control" name="date_puk" placeholder="Date PUK" autocomplete="off" id="date_puk" />
                      </div>
                    </div>
                    <div class="form-group row">
                      ...
                      <select class="form-control" required="required" data-plugin="select2" id="ship" name="ship" data-placeholder="Select Ship">
                          ...
                          <option <?php if($val->id_ship == $income->code_ship){ echo 'selected="selected"'; } ?> value="<?php echo $val->id_ship?>">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                         <input type="date" value="<?=$income->date_forecast?>" required="required" class="form-control" name="date_forecast" placeholder="Date Forecast" autocomplete="off" id="date_forecast" />
                      </div>
                    </div>
