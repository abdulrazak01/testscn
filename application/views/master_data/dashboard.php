...
<div class="page">
  <div class="page-content container-fluid">
        <header>
          <h2 class="gradient-text" style="text-align: center;"><b>Shipping</b></h2><br>
        </header>
        <div class="row" data-plugin="matchHeight" data-by-row="true">

          <div class="col-xl-4 col-md-6">
            <!-- Widget Linearea Three -->
            <a href="<?php echo base_url('frontend/master_data/menu_master_data');?>">
            <div class="card card-shadow" id="widgetLineareaThree">
              <div class="card-block p-20 pt-10 bg-card">
                <div class="clearfix">
                  <div class="grey-800 float-left py-10">
                    <i class="icon md-square-right grey-600 font-size-24 vertical-align-bottom mr-5"></i><b>Master Data</b>
                  </div>
        ...
        <div class="col-xl-4 col-md-6">
          <a href="<?php echo base_url('frontend/incoming_ship/list_incoming_ship');?>">
            <div class="card card-shadow menu" id="widgetLineareaThree">
              <div class="card-block p-20 pt-10 bg-card">
                <div class="clearfix">
                  <div class="grey-800 float-left py-10">
                    <i class="icon md-square-right grey-600 font-size-24 vertical-align-bottom mr-5"></i>        <b>Incoming Ship</b>
                  </div>
                </div>
        ...
        <div class="col-xl-4 col-md-6">
          <a href="<?php echo base_url('frontend/outgoing_ship/list_outgoing_ship');?>">
            <div class="card card-shadow menu" id="widgetLineareaThree">
              <div class="card-block p-20 pt-10 bg-card">
                <div class="clearfix">
                  <div class="grey-800 float-left py-10">
                    <i class="icon md-square-right grey-600 font-size-24 vertical-align-bottom mr-5"></i><b>Outgoing Ship</b>
                  </div>
                </div>
