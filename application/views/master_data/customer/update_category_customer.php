              ...
              <div class="col-md-12 col-lg-6">
                <div class="example-wrap">
                  <div class="example">
                    ...
                    <?= form_open(base_url('frontend/master_data/update_category_customer'),  'id="login_validation" enctype="multipart/form-data"') ?>
                    <div class="form-group row">
                      <label class="col-md-3 form-control-label"><b>Code Type Customer<b style="color: red;">*</b> : </b></label>
                      <div class="col-md-9">
                        <input type="text" readonly required="required"  value="<?=$cat_cus->code?>" class="form-control" name="code_type" placeholder="Code Type Customer" autocomplete="off" id="name" />
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-md-3 form-control-label"><b>Name Type<b style="color: red;">*</b> : </b></label>
                      <div class="col-md-9">
                         <input type="text" required="required" value="<?=$cat_cus->type?>" class="form-control" name="name" placeholder="Name Type" autocomplete="off" id="name" />
                      </div>
                    </div>
