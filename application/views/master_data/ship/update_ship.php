<div class="page">
  ...
  <div class="page-header" style="text-align: center; padding: 0px;">
    <h1 class="page-title">Form Update Ship</h1>
  </div>
              ...
              <div class="col-md-12 col-lg-6">
                <div class="example-wrap">
                  <div class="example">
                    ...
                    <?= form_open(base_url('frontend/master_data/update_ship'),  'id="login_validation" enctype="multipart/form-data"') ?>
                    <div class="form-group row">
                      <label class="col-md-3 form-control-label"><b>Code<b style="color: red;">*</b> : </b></label>
                      <div class="col-md-9">
                        <input type="text" required="required" value="<?=$ship->code?>" class="form-control" name="code_type" placeholder="Code" autocomplete="off" id="name" />
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-md-3 form-control-label"><b>Name Ship<b style="color: red;">*</b> : </b></label>
                      <div class="col-md-9">
                         <input type="text" required="required" value="<?=$ship->name_ship?>" class="form-control" name="name_ship" placeholder="Name Ship" autocomplete="off" id="name" />
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                      <select class="form-control" required="required" data-plugin="select2" name="cus" data-placeholder="Select Customer">
                          <option></option>
                          <?php foreach ($cus as $val) { ?>
                          <option <?php if($val->id_customer == $ship->code_customer){ echo 'selected="selected"'; } ?> value="<?php echo $val->id_customer?>">
              ...
              <div class="col-md-12 col-lg-6">
                <div class="example-wrap">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-md-9">
                         <input type="text" value="<?=$ship->gross_ton?>" required="required" class="form-control" name="gross_ton" placeholder="Gross Ton" autocomplete="off" id="name" />
                      </div>
                    </div>
