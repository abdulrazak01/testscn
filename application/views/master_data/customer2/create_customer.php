<div class="page">
  ...
  <div class="page-header" style="text-align: center; padding: 0px;">
    <h1 class="page-title">Form Create Customer</h1>
  </div>
              ...
              <div class="col-md-12 col-lg-6">
                <div class="example-wrap">
                  <div class="example">
                    ...
                    <?= form_open(base_url('frontend/master_data/create_customer'),  'id="login_validation" enctype="multipart/form-data"') ?>
                    <div class="form-group row">
                      <label class="col-md-3 form-control-label"><b>Code Customer<b style="color: red;">*</b> : </b></label>
                      <div class="col-md-9">
                        <input type="text" required="required" class="form-control" name="code_type" placeholder="Code Customer" autocomplete="off" id="name" />
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-md-3 form-control-label"><b>Name Customer<b style="color: red;">*</b> : </b></label>
                      <div class="col-md-9">
                         <input type="text" required="required" class="form-control" name="name" placeholder="Name Customer" autocomplete="off" id="name" />
                      </div>
                    </div>
                    <div class="form-group row">
