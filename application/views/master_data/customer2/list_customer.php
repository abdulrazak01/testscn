<div class="page">
  <div class="page-header">
    <ol class="breadcrumb">
      <a href="<?php echo base_url('frontend/master_data/menu_master_data'); ?>" type="button" class="btn btn-round btn-info"><i class="icon md-home" aria-hidden="true"></i>Menu Dashboard</a>
        &nbsp;&nbsp;
        <a href="<?php echo base_url('frontend/master_data/create_customer'); ?>" class="btn btn-round btn-danger"><i class="icon md-plus" aria-hidden="true"></i>&nbsp; Create &nbsp;</a>&emsp;&emsp;
    </ol>
    <br>
  ...
  <?php } ?>
    ...
    <h3 class="panel-title" style="text-align: center; padding: 0px;"><b>List Customer</b></h3>
      ...
      if (isConfirm) {
        $.ajax({
          success: function(data) {
              window.location.href = '<?= base_url("frontend/master_data/update_customer/")?>'+id;
          }
        });
      } else {
  ...
  $(".delete").click(function(){
    ...
    function(isConfirm) {
      if (isConfirm) {
        $.ajax({
          success: function(data) {
              window.location.href = '<?= base_url("frontend/master_data/delete_customer/")?>'+id;
          }
        });
      } else {
        swal("Cancelled", "Your Cancel Action :)", "error");
